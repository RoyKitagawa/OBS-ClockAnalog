...
追加の要望等ございましたらIssuesに起票、もしくは作者のTwitterのDM等にご連絡をお願いいたします。

本ソフトウェア、並びに関連するソフトウェアの更新情報は```#OBS時計```というハッシュタグをつけてTwitterにて共有しています。  
最新情報、及び更新情報等確認されるかたは上記ハッシュタグをご確認お願いいたします。  
...
### 制作協力
本ソフトウェアの各種テンプレート画像のデザインは以下の方によって作成頂いております。  
  
大嘉見マユ 様  
Twitter: https://twitter.com/Wolf_mayu1129  
YouTube: https://www.youtube.com/channel/UCR5hVLpftFdOO9sqSk5Nffg    
